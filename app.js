/* EnglishLegalese.com v1.54.6 — Final Public UX Quality Pass.
   Public-facing experience only. Preserve existing workflows, data structures, and functionality. */
(() => {
  ...
  const languages = ['English','Spanish','Chinese','Arabic','French','Portuguese','Russian','Turkish','Hindi','Urdu','Korean','Japanese','Vietnamese','Indonesian','German','Italian','Polish','Ukrainian','Persian / Farsi','Bengali','Thai','Dutch','Greek','Hebrew','Swedish','Norwegian','Danish','Finnish','Romanian','Czech','Hungarian','Malay','Tagalog','Swahili'];
  ...
  function launchReady(){
    return `<section class="section" id="launch"><div class="container section-head"><div><div class="eyebrow">Learning experience</div><h2>A trusted learning environment built for professionals.</h2></div><p>EnglishLegalese.com provides professional Legal English training through AI practice, live teachers, and structured learning paths.</p></div><div class="container grid cols-2"><article class="panel"><h3>Learning standards</h3><ul class="feature-list compact">${launchGates.map(x => `<li>${escapeHtml(x)}</li>`).join('')}</ul></article><article class="panel warning-card"><h3>Progress protection</h3><p>Your learning experience is designed to protect ${protectedRecords.length} record types including ${protectedRecords.slice(0,10).join(', ')} and more.</p><p class="notice">Your learning history, practice activities, progress records, and learning materials are organized to support continuity.</p></article></div></section>`;
  }
  function trust(){
    return `<section class="section alt" id="trust"><div class="container section-head"><div><div class="eyebrow">Trust center</div><h2>Clear boundaries. Professional learning. Responsible AI use.</h2></div><p>EnglishLegalese.com provides education, Legal English training, and professional communication practice only.</p></div><div class="container grid cols-3">${card('Not a law firm','The platform does not provide legal advice or decide legal rights, obligations, deadlines, filings, or strategy.')}${card('Not certified translation','Native-language explanations help learning. They are not certified translation, court interpretation, or final legal meaning.')}${card('Private by default','Employer reports are privacy-safe. Private learner drafts, uploads, raw AI practice, and teacher-private notes are not shared by default.')}</div></section>`;
  }
